...
const Dashboard = ({ user, setUser }) => {
  ...
  const chatHistory = [
    { id: 1, title: "Admission Requirements", time: "2 minutes ago", dateGroup: "TODAY" },
  ];
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setMessages([
        {
          id: 1,
          text: "Hello! I'm the Admission Chatbot. How can I help you with your admission queries today?",
          sender: "bot",
